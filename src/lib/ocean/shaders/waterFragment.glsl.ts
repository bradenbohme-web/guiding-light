...
void main() {
  ...
  // ---- Physics-based foam (Gerstner steepness + SWE heightfield) ----
  ...
  float sweFoam = vHeightfieldFoam; // Wake/interaction foam from SWE
  float totalFoam = clamp(foamSoft + crestFoam + sweFoam, 0.0, 1.0);
